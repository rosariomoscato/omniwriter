...
db.prepare('INSERT INTO users (id, email, password_hash, name, role, subscription_status, preferred_language, theme_preference, created_at, updated_at, bio, avatar_url) VALUES (?, ?, ?, ?, ?, ?, ?, ?, datetime(\'now\'), datetime(\'now\'), \'\', \'\')')
