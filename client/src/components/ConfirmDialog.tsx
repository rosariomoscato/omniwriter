 ...
 * Variants:
 * - danger: Red theme for destructive actions (delete)
 * - warning: Yellow/Orange theme for caution actions
...
export default function ConfirmDialog({
  ...
  const modalId = useState(() => `confirm-${Math.random().toString(36).substring(2, 9)}`)[0];
    ...
    >
      ...
      >
        ...
        <p
          ...
          className="text-sm text-gray-600 dark:text-gray-400 mb-2 whitespace-pre-line"
        >
          {message}
        </p>
        ...
        <div className="flex gap-3 mt-4">
          ...
          <button
            onClick={onConfirm}
            className={`flex-1 px-4 py-2 ${styles.buttonBg} text-white rounded-lg font-medium transition-colors flex items-center justify-center gap-2`}
          >
