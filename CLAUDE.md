...
This command **requires** the project directory as an argument via `/Users/rosario/CODICE/omniwriter`.

**Example:** `/create-spec generations/my-app`

**Output location:** `/Users/rosario/CODICE/omniwriter/.autoforge/prompts/app_spec.txt` and `/Users/rosario/CODICE/omniwriter/.autoforge/prompts/initializer_prompt.md`

If `/Users/rosario/CODICE/omniwriter` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `/Users/rosario/CODICE/omniwriter/.autoforge/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `/Users/rosario/CODICE/omniwriter/.autoforge/prompts/app_spec.txt`
...
**Output path:** `/Users/rosario/CODICE/omniwriter/.autoforge/prompts/initializer_prompt.md`
...
**Output path:** `/Users/rosario/CODICE/omniwriter/.autoforge/prompts/.spec_status.json`
...
> "Your specification files have been created in `/Users/rosario/CODICE/omniwriter/.autoforge/prompts/`!
>
> **Files created:**
> - `/Users/rosario/CODICE/omniwriter/.autoforge/prompts/app_spec.txt`
> - `/Users/rosario/CODICE/omniwriter/.autoforge/prompts/initializer_prompt.md`
>
